...
pfodDelay mainDelay; // the delay object, the overall delay
pfodDelay firstPartDelay; // the delay object, the delay until we 'freeze' the main delay
pfodDelay freezeDelay; // the delay object, the delay of the 'freeze' after which we 're-start' the main delay
