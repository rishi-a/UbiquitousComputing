...
void loop()
{
  ...
  if((newMillis - oldMillis) % 50){
    Serial.printf("%f %f %f %f %f %f %f %f %f %d %d %f %f %f\n", accelerometerX, accelerometerY, accelerometerZ,gyroscopeX, gyroscopeY, gyroscopeZ, magneticX, magneticY, magneticZ,proximity, gesture, temperature, humidity, barometricPressure);
  }
